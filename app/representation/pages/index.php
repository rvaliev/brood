...
<section class="clearFix">
    <div class="container">
        ...
        <h3 class="sectionHeadLine">Stap 1: Kies één broodje:</h3>
    </div>
</section>
<section class="clearFix">
    <div class="container">
        <article class="clearFix">
            ...
            <div class="productContent clearFix">
                ...
                <a class="bestelKnoop show-login" href="beleg.php?id=1">Neem er één</a>
        ...
        <article class="clearFix">
            ...
            <div class="productContent clearFix">
                ...
                <a class="bestelKnoop" href="beleg.php?id=2">Neem er één</a>
                <h3 class="productDiscription">
                    Ingredienten: bloem, gist, water, suiker, zout
                </h3>
            </div>
        ...
        <article class="clearFix">
            ...
            <div class="productContent clearFix">
                ...
                <a class="bestelKnoop" href="beleg.php?id=3">Neem er één</a>
                <h3 class="productDiscription">
                    Ingredienten: bloem, gist, water, suiker, zout
                </h3>
            </div>
        ...
        <article class="clearFix">
            ...
            <div class="productContent clearFix">
                ...
                <a class="bestelKnoop" href="beleg.php?id=4">Neem er één</a>
                <h3 class="productDiscription">
                    Ingredienten: bloem, gist, water, suiker, zout
                </h3>
            </div>
